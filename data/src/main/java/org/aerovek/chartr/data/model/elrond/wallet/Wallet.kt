...
package org.aerovek.chartr.data.model.elrond.wallet
...
class Wallet(
    ...
    companion object {
        ...
        @Throws(ElrondException.CannotDeriveKeysException::class)
        fun createFromMnemonic(mnemonic: String, accountIndex: Long): Wallet {
            return try {
                ...
                throw ElrondException.CannotDeriveKeysException()
            }
        }

        @Throws(ElrondException.CannotGenerateMnemonicException::class)
        fun generateMnemonic(): List<String> {
            return try {
                val entropy = generateEntropy()
                MnemonicCode().toMnemonic(entropy)
            } catch (error: IOException) {
                throw ElrondException.CannotGenerateMnemonicException()
